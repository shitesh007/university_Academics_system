# Generated by Django 6.0.3 on 2026-03-04 07:36
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='subject',
            name='faculty',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='subjects', to='api.faculty'),
        ),
        migrations.CreateModel(
            name='Material',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(max_length=255)),
                ('category', models.CharField(choices=[('notes', 'Notes'), ('ebook', 'E-book'), ('pyq', 'PYQs'), ('video', 'Tutorial Video'), ('topic', 'Important Topics'), ('assignment', 'Assignment'), ('other', 'Other')], max_length=50)),
                ('file_url', models.URLField(max_length=500)),
                ('upload_date', models.DateTimeField(auto_now_add=True)),
                ('size_mb', models.DecimalField(decimal_places=2, default=0.0, max_digits=6)),
                ('subject', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='materials', to='api.subject')),
                ('uploaded_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='uploaded_materials', to='api.faculty')),
            ],
        ),
        migrations.CreateModel(
            name='Query',
            fields=[
                ...
                ('subject', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='queries', to='api.subject')),
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='queries', to='api.student')),
            ],
        ),
        migrations.CreateModel(
            name='Submission',
